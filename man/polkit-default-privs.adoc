...
DESCRIPTION
-----------
The files _/usr/share/polkit-default-privs/*_ define different security profiles
...
- *local*: this is a custom profile located in
  _/etc/polkit-default-privs.local_ that can be used on top of the predefined
...
`/usr/share/polkit-default-privs/package-overrides.d/*`
